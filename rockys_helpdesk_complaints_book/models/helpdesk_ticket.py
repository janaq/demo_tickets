...
class HDTicket(models.Model):
    ...
    restaurant_id = fields.Char('Restaurante')
    ...
    claimant_id = fields.Char('Reclamate')
    ...
    parent_ct_id = fields.Char('Padre/Madre')
    ...
    order_channel_id = fields.Char('Canal del pedido')
